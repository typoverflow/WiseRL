...
from wiserl.dataset import D4RLOfflineDataset, MetaworldOfflineDataset
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        bc_path = args["bc_path"] if "bc_path" in args else "log/BehavioralCloning/default/button-press-v2/seed0-05-15-20-34-1295158/output/final.pt"
        bc.load(bc_path)
        ...
        for i in trange(N):
            ...
            env.reset()
            env.set_state(np.array([ 2.16367892e+00, -5.62765180e-01, -1.22557366e+00,  2.17345906e+00,
        1.23729245e+00,  1.00300109e+00,  1.91836352e+00, -1.71855991e-04,
        1.71795511e-04,  0.00000000e+00, 1.20754463e-01,  7.32927680e-01, -2.64408957e-01,  1.59606754e-01,
        8.22370354e-01,  4.75741121e-01,  1.32382888e+00,  2.02805444e-07,
        1.93022621e-07,  0.00000000e+00]))
